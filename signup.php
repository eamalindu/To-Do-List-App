        ...
        <div class="card bg-dark text-white">
            ...
            <div class="card-body">
                <form action="php/add_user.php" method="post">
                    <div class="mb-3">
                        <label for="textFullName" class="form-label">Enter Your Name</label>
                        <input type="text" class="form-control" placeholder="John Doe" id="textFullName"
                            name="textFullName" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="textPasswordConfirm" class="form-label">Confirm Your Password</label>
                        <input type="password" class="form-control" placeholder="********" id="textPasswordConfirm"
                            name="textPasswordConfirm" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-0 d-flex justify-content-end gap-2">
                        <button class="btn btn-primary" id="btnSignup" name="btnSignup" type="submit">Signup</button>
